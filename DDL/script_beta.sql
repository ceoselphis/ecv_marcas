...
CREATE TABLE marcas_solicitudes (
                ...
                oficina_tramitante VARCHAR(255) NOT NULL,
...
CREATE TABLE registros_sanitarios (
                ...
                oficina_asignada INT NOT NULL,
                pais_reg INT NOT NULL,
                client_id INT NOT NULL,
                grupo_registro INT NOT NULL,
                staff_id_1 INT NOT NULL,
...
ALTER TABLE solicitud_patentes ADD CONSTRAINT oficinas_solicitud_patentes_fk
FOREIGN KEY (oficina_gest)
REFERENCES oficinas (oficina_id)
ON DELETE CASCADE
ON UPDATE CASCADE;

ALTER TABLE registros_sanitarios ADD CONSTRAINT oficinas_registros_sanitarios_fk
FOREIGN KEY (oficina_asignada)
REFERENCES oficinas (oficina_id)
ON DELETE CASCADE
ON UPDATE CASCADE;
...
ALTER TABLE paises ADD CONSTRAINT paises_paises_fk
FOREIGN KEY (Parent_pais_id)
REFERENCES paises (pais_id)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
...
ALTER TABLE busqieda_tipo ADD CONSTRAINT marbusq_busqieda_tipo_fk
FOREIGN KEY (busq_id)
