      ...
      <div role="tabpanel" class="tab-pane<?php if (!$this->input->get('tab')) {
        ...
        <div class="row">
          ...
          <div class="col-md-<?php echo !isset($client) ? 12 : 8; ?>">
            ...
            <!-- Code Company -->
            <?php hooks()->do_action('before_customer_profile_code_field', $client ?? null); ?>
            <?php $value = (isset($client) ? $client->code : ''); ?>
            <?php $attrs = (isset($client) ? [] : ['autofocus' => true]); ?>
            <?php echo render_input('code', 'Código', $value, 'text', $attrs); ?>
            <!-- Parent Client -->
            <?php hooks()->do_action('before_customer_profile_parent_client_field', $client ?? null); ?>
            <?php $value = (isset($client) ? $client->parent_client : ''); ?>
            <?php $attrs = (isset($client) ? [] : ['autofocus' => true]); ?>
            <label class="form-client">
              Cliente Padre 
            </label>
