...
function _init_tasks_billable_select(e, t) {
  ...
  if (a.length > 0) {
    ...
    n.html(
      ...
      delay(function () {
        (n.attr("info-shown-count") < 3 ||
          void 0 === n.attr("info-shown-count")) &&
        $(".projects-wrapper").is(":visible") &&
          ...
          (n.attr(
              ...
              void 0 === n.attr("info-shown-count") ?
              1 :
              parseInt(n.attr("info-shown-count")) + 1
            ),
...
function init_editor(e, t) {
  ...
  if (0 !== a.length) {
    ...
    if (
      ("true" == isRTL && (i.directionality = "rtl"),
        "true" == isRTL && (i.plugins[0] += " directionality"),
        void 0 !== t)
    )
      for (var n in t)
...
function edit_note(e) {
  var t = $("body")
    ...
    .val();
  "" !== t &&
    ($.post(admin_url + "misc/edit_note/" + e, {
        description: t,
      }).done(function (a) {
...
function load_more_comments(e) {
  ...
  a <= i &&
    ($.post(admin_url + "newsfeed/init_post_comments/" + t, {
        page: a,
      }).done(function (i) {
...
function init_proposal_editor() {
  ...
  is_mobile() &&
    ...
    e.length > 0 &&
    ((t.templates = e),
      (t.plugins[3] = "template " + t.plugins[3]),
      (t.contextmenu = t.contextmenu.replace(
        "inserttable",
...
function edit_proposal_comment(e) {
  var t = $("body")
    ...
    .val();
  "" != t &&
    ($.post(admin_url + "proposals/edit_comment/" + e, {
        content: t,
      }).done(function (a) {
    ...
    return (
      get_taxes_dropdown_template(l, e.taxname).done(function (a) {
        ...
        l.length > 0 &&
          ...
          */
          (n +=
            '<td class="amount-container"> <span class="left-info" id="item_informacion"></span> <span class="amount" align="right">' +
            format_money(o, !0) +
            "</span></td>"),
          (n +=
...
function calculate_total() {
  ...
  $(".tax-area").remove(),
    $.each(p, function () {
      "" === (r = $(this).find("[data-quantity]").val()) &&
      ((r = 1), $(this).find("[data-quantity]").val(1)),
      (n = accounting.toFixed(
        $(this).find("td.rate input").val() * r,
    ...
    0 != u &&
    "before_tax" == v &&
    h.hasClass("discount-type-percent") ?
    (c = (l * u) / 100) :
    "" !== f &&
    0 != f &&
    "before_tax" == v &&
    h.hasClass("discount-type-fixed") &&
    (c = f),
    $.each(o, function (e, t) {
      if (
        "" !== u &&
        ...
        (total_tax_calculated = (t * u) / 100), (t -= total_tax_calculated);
      else if (
        "" !== f &&
        0 != f &&
        "before_tax" == v &&
  ...
  $('input[name="discount_total"]').val(
      accounting.toFixed(c, app.options.decimal_places)
    ),
    ...
    $(".subtotal").html(
      ...
      hidden_input(
        "subtotal",
        accounting.toFixed(l, app.options.decimal_places)
      )
    ),
    $(".total").html(
      format_money(d) +
      hidden_input("total", accounting.toFixed(d, app.options.decimal_places))
    ),
...
function delete_item(e, t) {
  console.log(" Borrar ITem ", e , " prueba " , t);
...
function init_currency(e, t) {
  console.log(" Llegue a Init Currency 2 ");
      ...
      i.length > 0 &&
        $.each(i, function (e, a) {
          ...
          $.notify("", {
              ...
              tag: a,
              closeTime: "0" != app.options.dismiss_desktop_not_after ?
...
function init_new_task_comment(e) {
  ...
  (t.mentions = {
    source: function (e, t, a) {
      n.length < 1 ?
        $.getJSON(
          admin_url + "tasks/get_staff_names_for_mentions/" + i,
          function (e) {
            (n = e), t(e);
          }
        ) :
  ...
  $(function () {
    ...
    totalUnreadNotifications > 0 &&
      ...
      $(document).on("focusin", function (e) {
        $(e.target).closest(".mce-window").length &&
    ...
    if (
      ($("body").on("change", 'input[name="contacted_today"]', function () {
        ...
        $("body").on("change loaded.bs.select", "#item_select", function () {
          console.log("Cambios en Item Select ");
