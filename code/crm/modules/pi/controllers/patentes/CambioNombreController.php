...
{
    protected $models = ['PatentesCambioNombre_model'];
    ...
    public function create()
    {
        ...
        */
        ...
        if (!empty($data)){
            ...
            $query = $CI->PatentesCambioNombre_model->insert($insert);
            if (isset($query)){
  ...
  public function turn_dates($date)
  {
    ...
    public function edit(string $id = null)
    {
        ...
        $CI->load->model("PatentesCambioNombre_model");
        $CI->load->helper('url');
        $query = $CI->PatentesCambioNombre_model->find($id);
        if(isset($query))
        {
          $patente[] = [
              "id" => $query[0]['id'] ,
            ...
            $data = [
                'id'            => $id,
                'tipo_registro' => $CI->PatentesCambioNombre_model->getTipoSolicitudes(),
                'clientes'      => $CI->PatentesCambioNombre_model->getAllClients(),
                'oficinas'      => $CI->PatentesCambioNombre_model->getAllOficinas(),
                'estado' => $CI->PatentesCambioNombre_model->getAllEstadoExpediente(),
                'responsable'   => $CI->PatentesCambioNombre_model->getAllStaff(),
                'pais_id'       => $CI->PatentesCambioNombre_model->getAllPaises(),
                'inventores'    => $CI->PatentesCambioNombre_model->getAllInventores(),
                'cod_contador'  =>  "P-{$id}",
                'solicitantes'  => $CI->PatentesCambioNombre_model->getAllClients(),
                'solicitantes_selected' => $CI->PatentesCambioNombre_model->findPatenteSolicitantes($id),
                'inventores_selected' => $CI->PatentesCambioNombre_model->findPatenteInventores($id),
                'projects' => $CI->PatentesCambioNombre_model->findAllProjects(),
                'tareas' => $CI->PatentesCambioNombre_model->findAllTipoTarea(),
                'values' => $patente,
                'tipo_evento' => $CI->PatentesCambioNombre_model->findAllTipoEvento(),
    ...
    public function update(string $id = null)
    {
        ...
        if ($CI->form_validation->run() == FALSE) {
            ...
            //We prepare the data 
            $query = $CI->PatentesCambioNombre_model->update($id, $data);
            if (isset($query))
            {
                return redirect('pi/patentes/SolicitudesController');
            }
