...
class Renovaciones_model extends BaseModel
{
    protected $primaryKey = 'id';
    protected $tableName =  'tbl_marcas_renovaciones';
    ...
    public function findAllRenovacionesMarcas($id = NULL){
        $this->db->select('*');
        $this->db->from('tbl_marcas_renovaciones');
