                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php echo form_textarea('direccion', set_value('direccion', ''), ['class' => 'form-control', 'maxlength' => '200']); ?>
                        ...
                        <div class="row row-group">
                            <ul class="list-inline pull-right mt-5">
                                <li><button id="cancelar" name="cancelar" type="button" class="btn btn-secondary">Cancelar</button>
                                </li>
