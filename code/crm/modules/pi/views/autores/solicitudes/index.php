                                    ...
                                    <div class="row row-group">
                                        ...
                                        <div class="col-md-4 col-md-offset-0">
                                            ...
                                            <select class='form-control' name='client_id' id="client_id">
                                                <option value=''>Seleccione una opcion</option>
                                                <?php foreach ($autores['Clientes'] as $key => $value) { ?>
                                                    <option value="<?php echo $key; ?>">
                                                        <?php echo $value; ?>
                                                    </option>
                                                <?php } ?>
                                    ...
                                    <div class="row row-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class='form-control' name='propietario_id' id="propietario_id">
                                                <option value=''>Seleccione una opcion</option>
                                                <?php foreach ($autores['propietarios'] as $key => $value) { ?>
                                                    <option value="<?php echo $key; ?>">
                                                        <?php echo $value; ?>
                                                    </option>
                                                <?php } ?>
                                    ...
                                    <div class="row row-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="est_sol_id" id="est_sol_id" class='form-control'>
                                                <option value=''>Seleccione una opcion</option>
                                                <?php foreach ($autores['Estado de Solicitud'] as $key => $value) { ?>
                                                    <option value="<?php echo $key; ?>">
                                                        <?php echo $value; ?>
                                                    </option>
                                                <?php } ?>
                                    ...
                                    <div class="row row-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="tip_eve_id" id="tip_eve_id" class='form-control'>
                                                <option value=''>Seleccione una opcion</option>
                                                <?php foreach ($autores['Tipo de Evento'] as $key => $value) { ?>
                                                    <option value="<?php echo $key; ?>">
                                                        <?php echo $value; ?>
                                                    </option>
                                                <?php } ?>
                                    ...
                                    <div class="row row-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="tip_sol_id" id="tip_sol_id" class='form-control'>
                                                <option value=''>Seleccione una opcion</option>
                                                <?php foreach ($autores['Tipo de Solicitud'] as $key => $value) { ?>
                                                    <option value="<?php echo $key; ?>">
                                                        <?php echo $value; ?>
                                                    </option>
                                                <?php } ?>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class='form-control' name='oficina_id' id="oficina_id">
                                                <option value=''>Seleccione una opcion</option>
                                                <?php foreach ($autores['Oficinas'] as $key => $value) { ?>
                                                    <option value="<?php echo $key; ?>">
                                                        <?php echo $value; ?>
                                                    </option>
                                                <?php } ?>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class='form-control' name='responsable_id' id='responsable_id'>
                                                <option value=''>Seleccione una opcion</option>
                                                <?php foreach ($autores['Responsables'] as $key => $value) { ?>
                                                    <option value="<?php echo $key; ?>">
                                                        <?php echo $value; ?>
                                                    </option>
                                                <?php } ?>
