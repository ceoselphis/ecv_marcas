            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <h4>Crear Solicitud de Patentes</h4>
                    </div>
                </div>
            </div>
            <div class="col-md-12">
                        ...
                        <div class="wizard">
                            ...
                            <div class="tab-content" id="main_form">
                                ...
                                <div class="tab-pane" role="tabpanel" id="step10">
                                    <div class="row">
                                        <a class="btn btn-primary newfact pull-right" href="<?php echo admin_url("pi/MarcasSolicitudesController/marcasInvoice/" . $id); ?>"><i class="fas fa-plus"></i> Añadir nueva factura</a>
