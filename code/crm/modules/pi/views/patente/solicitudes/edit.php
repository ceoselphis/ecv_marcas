              ...
              <div class="tab-content" id="main_form">
                ...
                <div class="tab-pane active" role="tabpanel" id="step1">
                  <div class="row">
                    <div class="col-md-6">
                      <h4>
                        <?php echo form_label("N° Expediente Solicitud: {$values['cod_contador']}"); ?>
                      </h4>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      echo form_dropdown(
                        'tipo_registro_id',
                        $tipo_registro,
                        set_value('tipo_registro_id', $values["tipo_registro_id"]),
                    ...
                    <div class="col-md-6">
                      ...
                      echo form_dropdown(
                        'client_id',
                        $clientes,
                        set_value('client_id', $values["client_id"]),
                  ...
                  <div class="row">
                    <div class="col-md-6" style="padding-top:15px;">
                      ...
                      echo form_dropdown(
                        'oficina_id',
                        $oficinas,
                        set_value('oficina_id', $values["oficina_id"]),
                    ...
                    <div class="col-md-6" style="padding-top:15px;">
                      ...
                      echo form_dropdown(
                        'staff_id',
                        $responsable,
                        set_value('staff_id', $values["staff_id"]),
                ...
                <div class="tab-pane" role="tabpanel" id="step2">
                  <div class="row">
                    <div class="col-md-6">
                      <h4>
                        <?php echo form_label("N° Expediente Solicitud: {$values['cod_contador']}"); ?><strong>
                          <?php echo ' '; ?>
                        </strong>
                      </h4>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <?php echo form_dropdown([
                        ...
                        'class' => 'form-control',
                        'options' => $pais_id,
                        'selected' => set_value('pais_id', $values["pais_id"]) //'226',
                      ]); ?>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <?php echo form_dropdown([
                        ...
                        'multiple' => 'multiple',
                        'options' => $inventores,
                        'selected' => set_value('inventores_id', $inventores_id),
                        "class" => "form-control"
                      ]);
                      ?>
                    </div>
                    <div class="col-md-6">
                      ...
                      <?php echo form_dropdown([
                        ...
                        'multiple' => 'multiple',
                        'options' => $clientes,
                        'selected' => set_value('solicitantes_id', $solicitantes_id),
                        "class" => "form-control"
                      ]);
                      ?>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <?php echo form_textarea([
                        ...
                        'name' => 'resumen',
                        'class' => 'form-control',
                        "value" => set_value('resumen', $values['resumen'])
                      ]);
                      ?>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      echo form_dropdown(
                        'estado_id',
                        $estados_solicitudes,
                        set_value('estado_id', $values['estado_id']),
                  ...
                  <div class="row">
                    <div class="col-md-6" style="padding-top:15px;">
                      ...
                      <?php echo form_input([
                        ...
                        'name' => 'solicitud',
                        'class' => 'form-control',
                        'value' => set_value('solicitud', $values['nro_solicitud']),
                  ...
                  <div class="row">
                    <div class="col-md-6" style="padding-top:15px;">
                      ...
                      echo form_input([
                        ...
                        'name' => 'registro',
                        'class' => 'form-control',
                        'value' => set_value('registro', $values['nro_registro']),
                  ...
                  <div class="row">
                    <div class="col-md-6" style="padding-top:15px;">
                      ...
                      <?php echo form_input([
                        ...
                        'name' => 'certificado',
                        'class' => 'form-control',
                        'value' => set_value('certificado', $values["nro_certificado"]),
                    ...
                    <div class="col-md-6" style="padding-top:15px;">
                      ...
                      echo form_input([
                        ...
                        'class' => 'form-control calendar',
                        'value' => set_value('fecha_certificado', $values['fecha_vencimiento_certificado']),
...
<?php $CI->load->view('patente/solicitudes/jsedit.php'); ?>
