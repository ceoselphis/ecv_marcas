                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <?php echo form_input([
                                                ...
                                                'required' => 'required',
                                                'class' => 'form-control',
                                                'value' => set_value('codigo', $values[0]['codigo']),
                                            ]);?>
                                        </div>
                                        <div class="col-md-6">
                                            <?php echo form_label('Pais', 'pais_id');?>
                                            <?php echo form_dropdown('pais_id', $paises ,set_value('pais_id', $values[0]['pais_id']), ['class' => 'form-control'])?>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php echo form_dropdown('estado_civil', ['Soltero(a)', 'Casado(a)', 'Divorciado(a)', 'Viudo(a)', 'Concubinato(a)'], set_value('estado_civil', $values[0]['estado_civil']), ['class' => 'form-control']);?>
                                        </div>
                                        <div class="col-md-6">
                                            <?php echo form_label('Representante Legal','representante_legal');?>
                                            <?php echo form_input('representante_legal',  set_value('representante_legal', $values[0]['representante_legal']), ['class' => 'form-control']);?>
                                        </div>
                                        <div class="col-md-12">
                                            <?php echo form_label('Direccion','direccion');?>
                                            <?php echo form_textarea('direccion',  set_value('direccion', $values[0]['direccion']), ['class' => 'form-control']);?>
                                        </div>
                                        <div class="col-md-6">
                                            <?php echo form_label('Ciudad','ciudad');?>
                                            <?php echo form_input('ciudad',  set_value('ciudad', $values[0]['ciudad']), ['class' => 'form-control']);?>
                                        </div>
                                        <div class="col-md-6">
                                            <?php echo form_label('Estado','estado');?>
                                            <?php echo form_input('estado',  set_value('estado', $values[0]['estado']), ['class' => 'form-control']);?>
                                        </div>
                                        <div class="col-md-6">
                                            <?php echo form_label('Código Postal','codigo_postal');?>
                                            <?php echo form_input('codigo_postal',  set_value('codigo_postal', $values[0]['codigo_postal']), ['class' => 'form-control']);?>
                                        </div> 
                                        <div class="col-md-6">
