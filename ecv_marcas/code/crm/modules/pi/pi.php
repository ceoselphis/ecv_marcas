...
function pi_menu_item_collapsible()
{
    ...
    $CI->app_menu->add_sidebar_children_item('52', [
        ...
        'name'     => 'Configuracion General', // The name if the item
        'href'     => admin_url('pi/SettingsController/show/contadores'), // URL of the item
        'position' => 11, // The menu position
        //'icon'     => 'fa fa-plus', // Font awesome icon
    ]);

    $CI->app_menu->add_sidebar_children_item('51', [
      'slug'   => 'contadores-galena',
      'name'  => 'Contadores Galena',
      'href'  => admin_url('pi/ContadoresGalenaController'),
      'position' => 11,
  ]);
