      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
            <div class="_buttons">
              <a href="<?php echo admin_url('pi/MarcasSolicitudesController/create'); ?>" class="btn btn-primary"><i class="fas fa-plus"></i> Nueva
                                ...
                                <div class="col-md-12 pre-scrollable">
                                    <table class="ultimate table table-responsive" id="tableResult">
                                        <thead style="text-align: justify;">
                                            <tr>
                        <th scope="col" class="px-6 py-4">Código</td>
                        <th scope="col" class="px-6 py-4">Propietario</td>
                        <th scope="col" class="px-6 py-4">Nombre</td>
                        <th scope="col" class="px-6 py-4">Estado</td>
                        <th scope="col" class="px-6 py-4">Solicitud</td>
                        <th scope="col" class="px-6 py-4">Fecha Solicitud</td>
                        <th scope="col" class="px-6 py-4">Registro</td>
                        <th scope="col" class="px-6 py-4">Acciones</td>
                      </tr>
                    </thead>
                    <tbody>
                    </tbody>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
                ...
                <div class="container-fluid">
                  <div class="row row-group">
                    ...
                    <div class="col-md-4">
                      ...
                      <select class='form-control' name='tipo_publicacion_id' id="tipo_publicacion_id">
                        <option value=''>Seleccione una opcion</option>
      ...
      <div class="modal-footer" style="padding-top: 1.5%;">
        ...
        <button id="generatePDF" type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa-regular fa-file-pdf"></i> Generar PDF</button>
      </div>
    </div>
  </div>
  <?php echo form_close(); ?>
...
<script>
  ...
  $("#generateExcel").on('click', function(event) {
    event.preventDefault();
    var params = {
      'cod_contador': $("input[name=cod_contador]").val(),
      'id_pais_solicitud': $("select[name=paisSol_id]").val(),
    ...
    $.ajax({
      url: "<?php echo admin_url('pi/MarcasSolicitudesController/generateReport/2') ?>",
      method: "POST",
      data: {
        "csrf_token_name": $("input[name=csrf_token_name]").val(),
        data: JSON.stringify(params),
  ...
  $("#generatePDF").on('click', function(event) {
    ...
    window.open("<?php echo admin_url('pi/MarcasSolicitudesController/generateReport/1') ?>" + "?csrf_token_name="+$("input[name=csrf_token_name]").val()+ "&data="+data, "_blank");
  })
