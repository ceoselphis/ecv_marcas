<script src="<?php echo site_url("assets/plugins/datatables/datatables.min.js?v=3.0.4");?>"></script>
<script>
  ...
  function TablaPrioridad() {
    ...
    tblPrioridadDT =
      new $("#prioridadTbl").DataTable({
        language: {
          url: '<?php echo site_url('assets/plugins/datatables/es-ES.json'); ?>'
        },
        autoWidth: false,
        data: table,
        destroy: true,
  ...
  $(document).on('submit', "#solicitudfrm", function(e) {
    ...
    formData.append('inventores_id', JSON.stringify($("#inventores_id").val()));
    ...
    $.ajax({
      url: '<?php echo admin_url('pi/patentes/SolicitudesController/update/'.$id); ?>',
      method: 'POST',
      data: formData,
      processData: false,
      contentType: false,
  ...
  $(document).on('click', "#invoiceMarcaSubmit", function() {
    ...
    $.ajax({
      url: "<?php echo admin_url("pi/patentes/SolicitudesController/addInvoice"); ?>",
      method: "POST",
      data: {
